...
\end{itemize}
\textbf{Meal Planning and Nutritional Optimization} \hfill 2026\\
\textit{Project Experience | Meal Optimization}
\begin{itemize}
    \item Formulated an optimization framework for meal planning and food allocation under nutritional, budget, and variety constraints. Explored linear and integer programming to balance daily nutrient targets with practical menu choices and analyze cost-nutrition-diversity trade-offs.
\end{itemize}
